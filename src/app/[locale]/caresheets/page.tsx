    ...
    <div className="min-h-screen bg-background py-16">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 relative">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-earth-dark mb-4 tracking-tight">Poradniki hodowlane</h1>
          <div className="w-24 h-1.5 bg-earth-accent rounded-full mx-auto mb-8"></div>
          <p className="text-lg md:text-xl text-earth-dark/70 max-w-3xl mx-auto font-medium">
            {t('pageDesc')}
          </p>
        </div>
